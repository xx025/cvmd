...
from cvmd import Yolov5Detect


def main():

    save_dir = Path("runs/yolov5_test")

    save_dir.mkdir(parents=True, exist_ok=True)

    model = Yolov5Detect(
        weights="/home/user/worksapce/cvmd/temp/yolov5l.torchscript",
        device="cuda",
        conf=0.4,
        iou=0.45,
        imgsz=640,
    ...
    iio.imwrite(save_dir / "yolov5l_blank_result.jpg", plot_im_blank)
